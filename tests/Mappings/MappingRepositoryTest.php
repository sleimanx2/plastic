...
class MappingRepositoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $repo = $this->getMock('LoRDFM\Plastic\Mappings\Mappings', ['getLastBatchNumber'], [
    ...
    {
        return new \LoRDFM\Plastic\Mappings\Mappings(Mockery::mock('Illuminate\Database\ConnectionResolverInterface'), 'mappings');
    }
}
